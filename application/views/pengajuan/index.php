                ...
                $.each(pb.lampiran, function(j, l) {
                    ...
                    if (imgExts.indexOf(ext) >= 0) {
                        thumbs += '<div class="col-6 col-md-3">' +
                                  ...
                                  '      <img src="' + baseUrl + l.file_path + '" class="img-fluid w-100" style="height:80px;object-fit:cover;" onerror="this.onerror=null;this.src=\'' + baseUrl + 'assets/img/img-error.png\';">' +
                                  '    </a>' +
